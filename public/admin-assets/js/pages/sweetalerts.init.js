...
// Custom Sweetalert [Auto close] =============================================================================================

{/* <button type="button" class="btn btn-primary btn-sm" id="sa-autoclose">Click me</button> // --- button for swal --- */}

// let message = localStorage.getItem("jovie_theme")

// document.getElementById("sa-autoclose") &&
// document.getElementById("sa-autoclose").addEventListener("click", function () {
//     var t;
//     Swal.fire({
//         // title: message,
//         html: message,
...
// --end-- Custom Sweetalert [Auto close] =====================================================================================    