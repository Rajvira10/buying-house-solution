                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="col">
                                        <h4 class="card-title mb-0">Call Statuses</h4>
                                    </div>
                                    <div class="col-sm-auto">
                                        @if (in_array('call_status.create', session('user_permissions')))
                                            <a href="{{ route('call_statuses.create') }}">
        ...
        const deleteCallStatus = (id) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('call_statuses.destroy') }}",
                        method: 'POST',
                        data: {
                            call_status_id: id,
                            _token: '{{ csrf_token() }}'
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                toaster('Call Status Deleted Successfully', 'success');
                            } else {
