                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="col">
                                        <h4 class="card-title mb-0">Business Categories</h4>
                                    </div>
                                    <div class="col-sm-auto">
                                        @if (in_array('business_category.create', session('user_permissions')))
                                            <a href="{{ route('business_categories.create') }}">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var dTable = $('#businessCategoryTable').DataTable({
                ...
                ajax: {
                    url: "{{ route('business_categories.index') }}",
                    type: "get"
                },
                columns: [{
                        data: 'DT_RowIndex',
        ...
        const deleteBusinessCategory = (id) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('business_categories.destroy') }}",
                        method: 'POST',
                        data: {
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                toaster('Business Category Deleted Successfully', 'success');
                            } else {
