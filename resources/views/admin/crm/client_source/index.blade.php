                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="col">
                                        <h4 class="card-title mb-0">Client Sources</h4>
                                    </div>
                                    <div class="col-sm-auto">
                                        @if (in_array('client_source.create', session('user_permissions')))
                                            <a href="{{ route('client_sources.create') }}">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var dTable = $('#businessCategoryTable').DataTable({
                ...
                ajax: {
                    url: "{{ route('client_sources.index') }}",
                    type: "get"
                },
                columns: [{
                        data: 'DT_RowIndex',
        ...
        const deleteClientSource = (id) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('client_sources.destroy') }}",
                        method: 'POST',
                        data: {
                            client_source_id: id,
                            _token: '{{ csrf_token() }}'
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                toaster('Client Source Deleted Successfully', 'success');
                            } else {
