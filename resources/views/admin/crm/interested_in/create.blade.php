...
@section('title', 'Create Interested In')
@section('content')
                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Add Interested In</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card ">
                            <div class="card-header">
                                <h3>{{ __('Add Interested In') }}</h3>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('interested_ins.store') }}" method="post" class="form-group"
