                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="col">
                                        <h4 class="card-title mb-0">Interested Ins</h4>
                                    </div>
                                    <div class="col-sm-auto">
                                        @if (in_array('interested_in.create', session('user_permissions')))
                                            <a href="{{ route('interested_ins.create') }}">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var dTable = $('#businessCategoryTable').DataTable({
                ...
                ajax: {
                    url: "{{ route('interested_ins.index') }}",
                    type: "get"
                },
                columns: [{
                        data: 'DT_RowIndex',
        ...
        const deleteInterestedIn = (id) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('interested_ins.destroy') }}",
                        method: 'POST',
                        data: {
                            interested_in_id: id,
                            _token: '{{ csrf_token() }}'
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                toaster('Interested In Deleted Successfully', 'success');
                            } else {
