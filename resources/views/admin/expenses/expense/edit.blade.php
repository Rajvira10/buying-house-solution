                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input data-provider="flatpickr" data-date-format="d/m/Y"
                                                    ...
                                                    value="{{ date('d/m/Y', strtotime($expense->date)) }}" placeholder="">
                                                ...
                                                <select id="expense_category_id"
                                                    ...
                                                    @foreach ($expense_categories as $expense_category)
                                                        <option class="expense-category-field"
                                                            ...
                                                            {{ $expense_category->id == $expense->expense_category_id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input id="amount" type="text"
                                                    ...
                                                    name="amount" value="{{ $expense->amount }}" placeholder="">
                                                <div class="help-block with-errors"></div>
                                                @error('amount')
                                                    <span class="text-danger-error" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="note"
                                                    ...
                                                    value="{{ $expense->note }}" placeholder="">
                                                <div class="help-block with-errors"></div>
                                                @error('note')
                                                    <span class="text-danger-error" role="alert">
                                                        <strong>{{ $message }}</strong>
