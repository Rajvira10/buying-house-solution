                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="col">
                                        <h4 class="card-title mb-0">Pending Returns of {{ $investment->investment_no }}</h4>
                                    </div>
                            ...
                            <div class="card-body">
                                <div id="pendingReturnsList">
                                    <div class="card-body">
                                        <table id="pendingReturnsTable" class="table">
...
@section('custom-script')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var dTable = $('#pendingReturnsTable').DataTable({
                order: [],
                lengthMenu: [
                    [10, 25, 50, 100, -1],
                    [10, 25, 50, 100, "All"]
                ...
                ajax: {
                    url: "{{ route('investments.pending_returns', $investment->id) }}",
                    type: "get"
                },
                columns: [{
                        data: 'date',
