                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">View Paybacks</li>
                                </ol>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="">
                                        <h4 class="card-title mb-0">View Paybacks of {{ $loan->loan_no }}</h4>
                                    </div>
                                    <div class="">
                            ...
                            <div class="card-body">
                                <div id="approvedPaybacksList">
                                    <div class="card-body">
                                        <table id="approvedPaybacksTable" class="table">
...
@section('custom-script')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var dTable = $('#approvedPaybacksTable').DataTable({
                order: [],
                lengthMenu: [
                    [10, 25, 50, 100, -1],
                    [10, 25, 50, 100, "All"]
                ...
                ajax: {
                    url: "{{ route('loans.approved_paybacks', $loan->id) }}",
                    type: "get"
                },
                columns: [{
                        data: 'date',
