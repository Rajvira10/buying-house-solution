...
@section('title', 'Add Loan Payback')
@section('content')
    <style>
        .selectr-input {
            outline: none;
                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Add Payback</li>
                                </ol>
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card ">
                            <div class="card-header">
                                <h3>Payback for {{ $loan->loan_no }}</h3>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('loans.storePayback', $loan->id) }}" method="post"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <a href="{{ route('loans.index') }}" style="border: none"
