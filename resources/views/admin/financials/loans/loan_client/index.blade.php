                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Loan Clients</li>
                                </ol>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="col">
                                        <h4 class="card-title mb-0">Loan Clients</h4>
                                    </div>
                                    <div class="col-sm-auto">
                                        <a href="{{ route('loan_clients.create') }}">
                            ...
                            <div class="card-body">
                                <div id="loan_clientList">
                                    <div class="card-body">
                                        <table id="loan_clientTable" class="table">
...
@section('custom-script')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var dTable = $('#loan_clientTable').DataTable({
                order: [],
                lengthMenu: [
                    [10, 25, 50, 100, -1],
                    [10, 25, 50, 100, "All"]
