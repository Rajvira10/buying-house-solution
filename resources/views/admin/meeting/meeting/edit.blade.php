                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input data-provider="flatpickr" data-date-format="d/m/Y"
                                                    data-default-date="{{ old('date') ?? date('d/m/Y', strtotime($meeting->date)) }}"
                                                    id="date" type="date"
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input data-provider="flatpickr" data-enable-time="true"
                                                    ...
                                                    value="{{ old('time') ?? date('h:i K', strtotime($meeting->time)) }}"
                                                    placeholder="">
                                                <div class="help-block with-errors"></div>
                                                @error('time')
                                                    <span class="text-danger-error" role="alert">
                                                ...
                                                <select id="meeting_title_id"
                                                    ...
                                                    @foreach ($meeting_titles as $value)
                                                        <option value="{{ $value->id }}"
                                                            {{ $meeting->meeting_title_id == $value->id ? 'selected' : '' }}>
                                                            {{ $value->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <select id="client_id"
                                                    ...
                                                    @foreach ($clients as $client)
                                                        <option value="{{ $client->id }}"
                                                            {{ $meeting->client_id == $client->id ? 'selected' : '' }}>
                                                            {{ $client->company_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <select id="meeting_type_id"
                                                    ...
                                                    @foreach ($meeting_types as $type)
                                                        <option value="{{ $type->id }}"
                                                            {{ $meeting->meeting_type_id == $type->id ? 'selected' : '' }}>
                                                            {{ $type->name }}
                                                    @endforeach
                                                </select>
                                                <div class="help-block with-errors"></div>
                                                ...
                                                <select id="meeting_status_id"
                                                    ...
                                                    @foreach ($meeting_statuses as $status)
                                                        <option value="{{ $status->id }}"
                                                            {{ $meeting->meeting_status_id == $status->id ? 'selected' : '' }}>
                                                            {{ $status->name }}
                                                    @endforeach
                                                </select>
                                                <div class="help-block with-errors"></div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="note" id="note" cols="30" rows="5"
                                                    class="form-control @error('note') is-invalid @enderror">{{ old('note') ?? $meeting->meeting_minutes()->first()->note }}</textarea>
                                                <div class="help-block with-errors"></div>
                                                @error('note')
                                                    <span class="text-danger-error" role="alert">
                                                        <strong>{{ $message }}</strong>
