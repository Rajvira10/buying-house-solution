                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="col">
                                        <h4 class="card-title mb-0">Meeting Titles</h4>
                                    </div>
                                    <div class="col-sm-auto">
                                        @if (in_array('meeting_title.create', session('user_permissions')))
                                            <a href="{{ route('meeting_titles.create') }}">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var dTable = $('#businessCategoryTable').DataTable({
                ...
                ajax: {
                    url: "{{ route('meeting_titles.index') }}",
                    type: "get"
                },
                columns: [{
                        data: 'DT_RowIndex',
        ...
        const deleteMeetingTitle = (id) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('meeting_titles.destroy') }}",
                        method: 'POST',
                        data: {
                            meeting_title_id: id,
                            _token: '{{ csrf_token() }}'
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                toaster('Meeting Title Deleted Successfully', 'success');
                            } else {
