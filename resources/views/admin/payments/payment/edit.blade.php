                        ...
                        <div class="card ">
                            <div class="card-body">
                                <form action="{{ route('payments.update', $payment->id) }}" method="post"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input data-provider="flatpickr" data-date-format="d/m/Y"
                                                    ...
                                                    value="{{ date('d/m/Y', strtotime($payment->date)) }}" placeholder="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="supplier_customer"
                                                    ...
                                                    <option value="Customer"
                                                        {{ $payment->supplier_customer == 'Customer' ? 'selected' : '' }}>
                                                        Customer</option>
                                                    <option value="Supplier"
                                                        {{ $payment->supplier_customer == 'Supplier' ? 'selected' : '' }}>
                                                        Supplier</option>
                                                </select>
                                                <div class="help-block with-errors"></div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select id="transaction_type"
                                                    ...
                                                    <option value="">Select</option>
                                                    <option value="Payable" {{ $payment->amount < 0 ? 'selected' : '' }}>
                                                        Paid
                                                    </option>
                                                    <option value="Receivable"
                                                        {{ $payment->amount >= 0 ? 'selected' : '' }}>Received</option>
                                                </select>
                                                <div class="help-block with-errors"></div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input id="amount" type="text"
                                                    ...
                                                    name="amount" value="{{ abs($payment->amount) }}" placeholder="">
                                                <div class="help-block with-errors"></div>
                                                @error('amount')
                                                    <span class="text-danger-error" role="alert">
                                                        <strong>{{ $message }}</strong>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-4 supplier_block"
                                            @if ($payment->supplier_customer == 'Customer') style="display: none" @endif>
                                            <div class="form-group">
                                                ...
                                                <select id="supplier_id"
                                                    ...
                                                    @foreach ($suppliers as $supplier)
                                                        <option value="{{ $supplier->id }}"
                                                            {{ $payment->paymentable_id == $supplier->id ? 'selected' : '' }}>
                                                            {{ $supplier->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-4 customer_block"
                                            @if ($payment->supplier_customer == 'Supplier') style="display: none" @endif>
                                            <div class="form-group">
                                                ...
                                                <select id="customer_id"
                                                    ...
                                                    @foreach ($customers as $customer)
                                                        <option value="{{ $customer->id }}"
                                                            {{ $payment->paymentable_id == $customer->id ? 'selected' : '' }}>
                                                            {{ $customer->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="note"
                                                    ...
                                                    value="{{ $payment->note }}" placeholder="">
                                                <div class="help-block with-errors"></div>
                                                @error('note')
                                                    <span class="text-danger-error" role="alert">
                                                        <strong>{{ $message }}</strong>
