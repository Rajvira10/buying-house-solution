                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="col">
                                        <h4 class="card-title mb-0">Project Statuses</h4>
                                    </div>
                                    <div class="col-sm-auto">
                                        @if (in_array('project_status.create', session('user_permissions')))
                                            <a href="{{ route('project_statuses.create') }}">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var dTable = $('#businessCategoryTable').DataTable({
                ...
                ajax: {
                    url: "{{ route('project_statuses.index') }}",
                    type: "get"
                },
                columns: [{
                        data: 'DT_RowIndex',
        ...
        const deleteProjectStatus = (id) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('project_statuses.destroy') }}",
                        method: 'POST',
                        data: {
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                toaster('Project Status Deleted Successfully', 'success');
                            } else {
