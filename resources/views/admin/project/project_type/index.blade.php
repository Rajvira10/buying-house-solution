                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="col">
                                        <h4 class="card-title mb-0">Project Types</h4>
                                    </div>
        ...
        const deleteProjectType = (id) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('project_types.destroy') }}",
                        method: 'POST',
                        data: {
                            project_type_id: id,
                            _token: '{{ csrf_token() }}'
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                toaster('Project Type Deleted Successfully', 'success');
                            } else {
