                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input id="product_name" type="text"
                                                    ...
                                                    name="product_name" value="{{ $query->product_name }}" placeholder="">
                                                ...
                                                <select id="trim_ids"
                                                    ...
                                                    @foreach ($trims as $trim)
                                                        <option class="expense-category-field" value="{{ $trim->id }}"
                                                            {{ in_array($trim->id, $query->getTrimIds()) ? 'selected' : '' }}>
                                                            {{ $trim->name }}</option>
                                                    @endforeach
                                                </select>
                                                <div class="help-block with-errors"></div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea id="details" class="form-control @error('details') is-invalid @enderror" name="details" rows="4">{{ $query->details }}</textarea>
                                                <div class="help-block with-errors"></div>
                                                @error('details')
                                                    <span class="text-danger-error" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input id="approximate_quantity" type="number"
                                                    ...
                                                    name="approximate_quantity" value="{{ $query->approximate_quantity }}"
                                                    placeholder="">
                                                <div class="help-block with-errors"></div>
                                                    ...
                                                    @foreach ($query->measurements as $document)
                                                        ...
                                                        @if (in_array(strtolower($extension), ['jpg', 'jpeg', 'png', 'gif']))
                                                            <img src="{{ $document->absolute_path }}"
                                                                alt="{{ $document->file_type }}" width="100"><br>
                                                        @else
                                                            <a href="{{ $document->absolute_path }}"
                                                                target="_blank">{{ $document->file_type }}</a><br>
                                                        @endif
                                                    @endforeach
                                                </div>
