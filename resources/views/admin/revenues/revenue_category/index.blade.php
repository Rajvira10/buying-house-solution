                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="col">
                                        <h4 class="card-title mb-0">Revenue Categories</h4>
                                    </div>
                                    <div class="col-sm-auto">
                                        @if (in_array('revenue_categories.create', session('user_permissions')))
                                            <a href="{{ route('revenue_categories.create') }}">
                            ...
                            <div class="card-body">
                                <div id="revenueCategoryList">
                                    <div class="card-body">
                                        <table id="revenueCategoryTable" class="table">
...
@section('custom-script')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var dTable = $('#revenueCategoryTable').DataTable({
                order: [],
                lengthMenu: [
                    [10, 25, 50, 100, -1],
                    [10, 25, 50, 100, "All"]
                ...
                ajax: {
                    url: "{{ route('revenue_categories.index') }}",
                    type: "get"
                },
                columns: [{
                        data: 'DT_RowIndex',
